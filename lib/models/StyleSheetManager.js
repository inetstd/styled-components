...
var StyleSheetManager = function (_Component) {
  ...
  StyleSheetManager.prototype.getChildContext = function getChildContext() {
    ...
    return _ref = {}, _ref[_StyleSheet.CONTEXT_KEY] = this.sheetInstance, _ref;
  };
  ...
  StyleSheetManager.prototype.componentWillMount = function componentWillMount() {
    if (this.props.sheet) {
      ...
      this.sheetInstance = new _StyleSheet2.default((0, _BrowserStyleSheet.tagConstructorWithTarget)(this.props.target));
    } else {
...
StyleSheetManager.propTypes = {
  sheet: require('prop-types').any,
  target: require('prop-types').any
};
...
StyleSheetManager.propTypes = {
  sheet: _propTypes2.default.oneOfType([_propTypes2.default.instanceOf(_StyleSheet2.default), _propTypes2.default.instanceOf(_ServerStyleSheet2.default)]),
