...
exports.tagConstructorWithTarget = tagConstructorWithTarget;
...
function tagConstructorWithTarget(target) {
  return function tagConstructor(isLocal) {
    var el = document.createElement('style');
    el.type = 'text/css';
    el.setAttribute(_StyleSheet.SC_ATTR, '');
    el.setAttribute(_StyleSheet.LOCAL_ATTR, isLocal ? 'true' : 'false');
    var targ = target || document.head;
...
exports.default = {
  create: function create() {
    ...
    return new _StyleSheet2.default(tagConstructorWithTarget(), tags, names);
  }
};